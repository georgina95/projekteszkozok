...
INSERT INTO state 	(id, triggered_by_id, state_date, comment, owner_id, status, report_id)
			VALUES 	(0, 1, '2017-10-20 09:00:00', 'Kiégett az izzó a 12. emeleti mosdóban.', null, 'OPEN', 1);
INSERT INTO state 	(id, triggered_by_id, state_date, comment, owner_id, status, report_id)
			VALUES 	(1, 3, '2017-10-21 12:20:00', 'Felveszem a bejelentést, hamarosan beszerzem az új izzókat.', 3, 'IN_PROGRESS', 1);
			
INSERT INTO state 	(id, triggered_by_id, state_date, comment, owner_id, status, report_id)
			VALUES 	(0, '2017-07-02 16:00:00', 'Beletört a kulcs az irodám ajtajának zárjába. Sürgősen javítást kérek.', null, 'OPEN', 2)
INSERT INTO state 	(id, triggered_by_id, state_date, comment, owner_id, status, report_id)
			VALUES 	(1, 3, '2017-07-02 16:30:00', 'Felveszem a bejelentést, két órán belül kicserélem a zárat.', 3, 'IN_PROGRESS', 2);
INSERT INTO state 	(id, triggered_by_id, state_date, comment, owner_id, status, report_id)
			VALUES 	(2, 3, '2017-07-02 17:45:00', 'Kicseréltem a zárat, az új kulcsokat leadtam az iroda tulajdonosának.', 3, 'SOLVED', 2);
