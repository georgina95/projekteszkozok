//CREATE TABLE user (nickname varchar(50), name varchar(50), email varchar(50), phone_number varchar(50), user_type varchar(50));

INSERT INTO user (nickname, name, email, phoneNumber, userType) VALUES ('VBela67', 'Végh Béla', 'vegh.b@business.hu', '06909538546', 'USER');
